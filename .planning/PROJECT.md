...
一个本地运行的 Web 积分管理系统，供 FDE 工程师一人操作，将《苍井寿司 AI 积分管理制度》的全部规则数字化落地。涵盖员工管理、四大积分类型（调查/培训/考核/成就）发放、积分兑换、成就积分审核流、排行榜与报表，所有数据存储在 SQLite 中。
